    ...
    <div [class]="toastClasses()">
      <div class="flex items-start gap-3">
        ...
        <button 
          ...
          (click)="remove.emit(toast().id)"
        >
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L11.414 10l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"></path></svg>
        </button>
      </div>
    </div>
  `
...
export class ToastComponent {
  ...
  toastClasses = computed(() => {
    ...
    return `toast ${typeClasses[this.toast().type]}`;
  });
}
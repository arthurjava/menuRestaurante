...
@Component({
  ...
  styles: [
    `
      ...
      .count-success {
        @apply bg-state-success text-white;
      }
      .count-warning {
        @apply bg-state-warning text-white;
      }
      .count-danger {
        @apply bg-state-danger text-white;
      }
      .count-info {
        @apply bg-state-info text-white;
      }
      .count-neutral {
        @apply bg-text-tertiary text-white;
      }

                ...
                <div class="p-4 space-y-4">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <mat-form-field appearance="outline" class="w-full">
                      ...
                      <input matInput formControlName="name" placeholder="Ex: Salmão Grelhado" maxlength="100">
                    ...
                    <mat-form-field appearance="outline" class="w-full">
                      ...
                      <mat-select formControlName="categoryId" [compareWith]="compareById">
                  ...
                  <mat-form-field appearance="outline" class="w-full">
                    ...
                    <textarea matInput formControlName="description" placeholder="Descreva o prato, ingredientes, modo de preparo..." rows="4" maxlength="1000"></textarea>
                    @if (form.get('description')?.touched && form.get('description')?.errors?.['maxlength']) {
                      <mat-error>Descrição deve ter no máximo 1000 caracteres</mat-error>
                    }
                  </mat-form-field>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <mat-form-field appearance="outline" class="w-full">
                      ...
                      @if (form.get('price')?.touched && form.get('price')?.errors) {
                        <mat-error>
                          @if (form.get('price')?.errors?.['required']) { Preço é obrigatório }
                          @if (form.get('price')?.errors?.['min']) { Preço deve ser maior ou igual a zero }
                        </mat-error>
                      }
                    </mat-form-field>
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (data && this.isOpen()) {
        ...
        this.form.reset({ name: '', description: '', price: 0, categoryId: '', active: true, displayOrder: 0 });
      }
    });

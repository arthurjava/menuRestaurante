...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, MatButtonModule, MatIconModule, MatFormFieldModule, MatInputModule, MatCheckboxModule, ButtonComponent],
  template: `
    <div
          ...
          <form [formGroup]="form" class="space-y-4">
            <div class="space-y-4">
              <mat-form-field appearance="outline" class="w-full">
                ...
                <input matInput formControlName="name" placeholder="Ex: Pratos Principais" maxlength="100">
              ...
              <mat-form-field appearance="outline" class="w-full">
                ...
                <input matInput formControlName="description" placeholder="Descrição da categoria" maxlength="500">
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (data && this.isOpen()) {
        ...
        this.form.reset({ name: '', description: '', active: true, displayOrder: 0, displayInMenu: true });
      }
    });
  }

...
- Name: menu.spec.ts >> Restaurante - Menu Module E2E Tests >> Admin Flows (require login) >> Dishes Management (/dishes) >> should navigate to dishes page
- Location: e2e\menu.spec.ts:241:11
...
Locator: locator('h1:has-text("Pratos")')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('h1:has-text("Pratos")') with timeout 10000ms
  - waiting for locator('h1:has-text("Pratos")')

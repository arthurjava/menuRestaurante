...
- Name: menu.spec.ts >> Restaurante - Menu Module E2E Tests >> Admin Flows (require login) >> Dishes Management (/dishes) >> should open create dish modal
- Location: e2e\menu.spec.ts:246:11
...
Call log:
  - waiting for locator('button:has-text("Novo Prato")')

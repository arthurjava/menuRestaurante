...
- Name: menu.spec.ts >> Restaurante - Menu Module E2E Tests >> Admin Flows (require login) >> Categories Management (/categories) >> should open create category modal
- Location: e2e\menu.spec.ts:194:11
...
Call log:
  - waiting for locator('button:has-text("Nova Categoria")')
...
- generic [ref=f1e5]:
  - generic [ref=f1e6]:
    - heading "Entrar no Sistema" [level=1] [ref=f1e7]
    - paragraph [ref=f1e8]: Acesse sua conta para gerenciar o cardápio
  - generic [ref=f1e9]:
    - generic [ref=f1e13]:
      - generic: E-mail
      - img [aria-hidden] [ref=f1e16]: email
      - textbox "E-mail" [ref=f1e18]:
        - /placeholder: seu@email.com
    - generic [ref=f1e22]:
      - generic: Senha
      - img [aria-hidden] [ref=f1e25]: lock
      - textbox "Senha" [ref=f1e27]:
        - /placeholder: ••••••••
    - generic [ref=f1e28]:
      - generic [ref=f1e29] [cursor=pointer]:
        - checkbox "Lembrar-me" [ref=f1e30]
        - generic [ref=f1e31]: Lembrar-me
      - link "Esqueceu a senha?" [ref=f1e32] [cursor=pointer]:
        - /url: /auth/forgot-password
    - generic [ref=f1e33]:
      - button "Entrar" [disabled]
  - paragraph [ref=f1e35]:
    - text: Não tem uma conta?
    - link "Cadastre-se" [ref=f1e36] [cursor=pointer]:
      - /url: /auth/register
```

...
- Name: menu.spec.ts >> Restaurante - Menu Module E2E Tests >> Admin Flows (require login) >> Categories Management (/categories) >> should test reorder drag-drop
- Location: e2e\menu.spec.ts:232:11
